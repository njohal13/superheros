//select the body (contents) of each tab
const allTabsBody = document.querySelectorAll('.tab-body-single')
//select the tabs: powerstats, biography, appearance, connections
const allTabsHead = document.querySelectorAll('.tab-head-single')

//select the search form input
...
//select the current tab and add a class of active-tab to it
...
//when this fxn is run, remove the class of 'show-tab'
const hideAllTabBody = () => allTabsBody.forEach(singleTabBody => singleTabBody.classList.remove('show-tab'))
//whene this fxn is run, remove the class of 'active-tab'
...
//when search item show list of search items
...
//when click on search list item
searchList.addEventListener('click', (event) => {
    let searchId = event.target.dataset.id
    //console.log(searchId) shows the id
